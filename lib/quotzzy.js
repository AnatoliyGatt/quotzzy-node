    ...
    var request = http.get({
        ...
        response.on("end", function() {
            ...
            if(parsedResponse.code && parsedResponse.message) {
                callback(new Error(parsedResponse.message, parsedResponse.code), null);
            } else {
...
/**
 * @public
 * @description Expose unchangeable instance of Quotzzy.
 * @returns {Object} - Unchangeable instance of Quotzzy.
 */

module.exports = function() {
    return freeze(new Quotzzy());
};